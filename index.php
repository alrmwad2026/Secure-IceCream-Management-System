  ...
  <section class="main-two" id="ic-cream">
    <div class="main2">
      ...
      <p>Lorem ipsum dolor sit amet consectetur.<br>
        ...
        dignissimos dolor ad ratione minima repella .<br></p>
      <div class="btn">
        <input class="botton-one" type="button" value="Buy Now" onclick="gotoproduct()">
        <script>function gotoproduct() { window.location.href = "#our-ic" }</script>
 ...
 <?php
            ...
            ?> 
            <div class="card-main3" id="section">
